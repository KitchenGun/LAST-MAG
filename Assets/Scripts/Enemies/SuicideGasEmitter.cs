...
{
    private const int k_ParticlesPerExplosion = 24;
    ...
    private static readonly Color k_LightGasColor = new Color32(200, 182, 74, 56);
    private static readonly Color k_DarkGasColor = new Color32(120, 109, 36, 72);
    ...
    public void EmitAt(Vector3 position, float radius)
    {
        ...
        for (int index = 0; index < k_ParticlesPerExplosion; index++)
        {
            ...
            ParticleSystem.EmitParams emitParams = new()
            {
                ...
                startSize = size,
                startColor = Color.Lerp(k_DarkGasColor, k_LightGasColor, Random.value),
